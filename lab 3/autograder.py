...
TEST_LIST_VARIABLE_NAME = "othello_tests"
...
def main():
    ...
    parser.add_argument(
        "--test", "-t", nargs="+",
        help="Specify one or more test names to run (e.g. Minimax Compute Utility "
             "Minimax Select Move). If omitted, all tests will be run.")
